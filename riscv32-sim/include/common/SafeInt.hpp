...
public:
  enum {
    ...
    IntZone_UintLT32_UintLT32 = safeint_internal::type_compare < T,
    U > ::isBothUnsigned &&safeint_internal::type_compare < T,
    U > ::isBothLT32Bit,
    IntZone_Uint32_UintLT64 = safeint_internal::type_compare < T,
    U > ::isBothUnsigned &&safeint_internal::int_traits<T>::is32Bit
                         &&safeint_internal::int_traits<U>::isLT64Bit,
    IntZone_UintLT32_Uint32 = safeint_internal::type_compare < T,
    U > ::isBothUnsigned &&safeint_internal::int_traits<T>::isLT32Bit
                         &&safeint_internal::int_traits<U>::is32Bit,
    IntZone_Uint64_Uint = safeint_internal::type_compare < T,
    U > ::isBothUnsigned &&safeint_internal::int_traits<T>::is64Bit,
    IntZone_UintLT64_Uint64 = safeint_internal::type_compare < T,
    U > ::isBothUnsigned &&safeint_internal::int_traits<T>::isLT64Bit
                         &&safeint_internal::int_traits<U>::is64Bit,
    // unsigned-signed
    IntZone_UintLT32_IntLT32 = !std::numeric_limits<T>::is_signed &&
                               std::numeric_limits<U>::is_signed &&
                               safeint_internal::type_compare < T,
    U > ::isBothLT32Bit,
    ...
    IntZone_Uint64_Int64 = safeint_internal::int_traits<T>::isUint64 &&
                           safeint_internal::int_traits<U>::isInt64,
    // signed-signed
    IntZone_IntLT32_IntLT32 = safeint_internal::type_compare < T,
    U > ::isBothSigned &&safeint_internal::type_compare < T,
    U > ::isBothLT32Bit,
    IntZone_Int32_IntLT64 = safeint_internal::type_compare < T,
    U > ::isBothSigned &&safeint_internal::int_traits<T>::is32Bit
                       &&safeint_internal::int_traits<U>::isLT64Bit,
    IntZone_IntLT32_Int32 = safeint_internal::type_compare < T,
    U > ::isBothSigned &&safeint_internal::int_traits<T>::isLT32Bit
                       &&safeint_internal::int_traits<U>::is32Bit,
    IntZone_Int64_Int64 = safeint_internal::type_compare < T,
    U > ::isBothSigned &&safeint_internal::int_traits<T>::isInt64
                       &&safeint_internal::int_traits<U>::isInt64,
    IntZone_Int64_Int = safeint_internal::type_compare < T,
    U > ::isBothSigned &&safeint_internal::int_traits<T>::is64Bit
                       &&safeint_internal::int_traits<U>::isLT64Bit,
    IntZone_IntLT64_Int64 = safeint_internal::type_compare < T,
    U > ::isBothSigned &&safeint_internal::int_traits<T>::isLT64Bit
                       &&safeint_internal::int_traits<U>::is64Bit,
    // signed-unsigned
...
public:
  SAFE_INT_NODISCARD _CONSTEXPR14 static bool Test(double d) {
    ...
    if (d < 0 || d > static_cast<double>(maxUnsignedDouble)) return false;
...
public:
  SAFE_INT_NODISCARD _CONSTEXPR14 static bool Cast(U u, T &t) SAFEINT_NOTHROW {
    if (u > (U)std::numeric_limits<T>::max()) return false;
  ...
  template <typename E>
  _CONSTEXPR14 static void CastThrow(U u, T &t) SAFEINT_CPP_THROW {
    if (u > (U)std::numeric_limits<T>::max()) E::SafeIntOnOverflow();
...
public:
  SAFE_INT_NODISCARD _CONSTEXPR14 static bool Cast(U u, T &t) SAFEINT_NOTHROW {
    ...
    if (u > std::numeric_limits<T>::max() || u < 0) return false;
  ...
  _CONSTEXPR14 static void CastThrow(U u, T &t) SAFEINT_CPP_THROW {
    // U is signed - T could be either signed or unsigned
    if (u > std::numeric_limits<T>::max() || u < 0) E::SafeIntOnOverflow();
...
public:
  ...
  _CONSTEXPR14 static void MultiplyThrow(const T &t, const U &u,
    ...
    if (tmp > std::numeric_limits<T>::max()) E::SafeIntOnOverflow();
...
public:
  ...
  SAFE_INT_NODISCARD _CONSTEXPR14 static bool Multiply(const T &t, const U &u,
    ...
    if (tmp > (std::uint64_t)std::numeric_limits<T>::max()) return false;
  ...
  RegMultiply(const std::uint64_t &a, const std::uint64_t &b,
    ...
    *pRet = 0;
    ...
    if (*pRet != 0) {
      ...
      if ((std::uint32_t)(*pRet >> 32) != 0) return false;
  ...
  RegMultiplyThrow(const std::uint64_t &a, const std::uint64_t &b,
...
#if SAFEINT_USE_INTRINSICS || SAFEINT_HAS_INT128
    if (!MultiplyUint64(a, b, pRet)) E::SafeIntOnOverflow();
#else
    std::uint32_t aHigh = 0, aLow = 0, bHigh = 0, bLow = 0;
    ...
    *pRet = 0;
    ...
    if (*pRet != 0) {
      ...
      if ((std::uint32_t)(*pRet >> 32) != 0) E::SafeIntOnOverflow();
...
public:
  ...
  RegMultiplyThrow(const std::uint64_t &a, std::uint32_t b,
                   std::uint64_t *pRet) SAFEINT_CPP_THROW {
#if SAFEINT_USE_INTRINSICS || SAFEINT_HAS_INT128
    if (!MultiplyUint64(a, (std::uint64_t)b, pRet)) E::SafeIntOnOverflow();
#else
    std::uint32_t aHigh = 0, aLow = 0;
...
public:
  ...
  RegMultiply(std::uint32_t a, const std::uint64_t &b,
    ...
    if ((std::uint32_t)(b >> 32) != 0 && a != 0) return false;
  ...
  RegMultiplyThrow(std::uint32_t a, const std::uint64_t &b,
    ...
    if ((std::uint32_t)(b >> 32) != 0 && a != 0) E::SafeIntOnOverflow();
...
#if SAFEINT_USE_INTRINSICS || SAFEINT_HAS_INT128
    if (!MultiplyInt64(a, b, pRet)) E::SafeIntOnOverflow();
#else
    bool aNegative = false;
    bool bNegative = false;
...
public:
  ...
  RegMultiplyThrow(const std::int64_t &a, std::uint32_t b,
                   std::int64_t *pRet) SAFEINT_CPP_THROW {
#if SAFEINT_USE_INTRINSICS || SAFEINT_HAS_INT128
    if (!MultiplyInt64(a, (std::int64_t)b, pRet)) E::SafeIntOnOverflow();
#else
    bool          aNegative = false;
    std::uint64_t tmp       = 0;
    std::int64_t  a1        = a;
